        ...
        <div :class="{
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="overflow-y-scroll flex-1 w-full" style="
                    ...
                    <nav class="pt-2">
                        <ul>
                            <NavigationSidebarItem title="Dashboard" :icon="undefined" href="dashboard"
                                :current="route.isCurrent('dashboard')"></NavigationSidebarItem>
                            <NavigationSidebarItem title="Time" :icon="undefined" :current="route.isCurrent('time')"
                                href="time">
                            </NavigationSidebarItem>

                            <NavigationSidebarItem title="Reporting" :icon="undefined" :sub-items="[
                                {
                                    title: 'Overview',
                                    route: 'reporting',
                                    show: true
                            ...
                            ]" :current="route.isCurrent('reporting') || route.isCurrent('reporting.detailed') || route.isCurrent('reporting.shared')"
                                href="reporting">
                            </NavigationSidebarItem>
                        </ul>
                    </nav>
                    ...
                    <nav>
                        <ul>
                            <NavigationSidebarItem v-if="canViewProjects()" title="Projects" :icon="undefined"
                                href="projects" :current="route.isCurrent('projects')
                                    "></NavigationSidebarItem>
                            <NavigationSidebarItem v-if="canViewClients()" title="Clients" :icon="undefined"
                                :current="route.isCurrent('clients')" href="clients
                                    "></NavigationSidebarItem>
                            <NavigationSidebarItem v-if="canViewMembers()" title="Members" :icon="undefined"
                                :current="route.isCurrent('members')" href="members
                                    "></NavigationSidebarItem>
                            <NavigationSidebarItem v-if="canViewTags()" title="Tags" :icon="undefined"
                                :current="route.isCurrent('tags')" href="tags"></NavigationSidebarItem>
                        </ul>
                    </nav>
                    ...
                    <nav>
                        <ul>
                            ...
                            " title="Billing" :icon="undefined" href="/billing"></NavigationSidebarItem>
                            <NavigationSidebarItem v-if="canUpdateOrganization()" title="Import / Export"
                                :icon="undefined" :current="route.isCurrent('import')" href="import">
                            </NavigationSidebarItem>
                            <NavigationSidebarItem v-if="canUpdateOrganization()" title="Settings" :icon="undefined"
                                :href="'teams.show' + 'page.props.auth.user.current_team.id'" :current="route.isCurrent(
                                    'teams.show' + 'page.props.auth.user.current_team.id'
                                )
                                    "></NavigationSidebarItem>
                        </ul>
                    </nav>
