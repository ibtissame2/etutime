...
<template>
	<DialogModal closeable :show="show" @close="show = false">
		...
		<template #content>
			<p>
				Merging the user <strong>{{ props.member.name }}</strong> into another one will transfer all time entries to the
				new user. <strong>This cannot be reverted!</strong>
			</p>
