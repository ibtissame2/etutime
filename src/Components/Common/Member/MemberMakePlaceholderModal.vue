...
<template>
	<DialogModal closeable :show="show" @close="show = false">
		...
		<template #content>
			<p>
				Deactivating the user <strong>{{ member.name }} </strong> will remove the user's access to the organization. You
				will not be billed for inactive users and all time entries will be preserved.
			</p>
		</template>
		<template #footer>
