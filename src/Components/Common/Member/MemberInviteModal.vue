		...
		<template #content>
			...
			<div v-else class="space-y-4">
				...
				<div v-if="availableRoles.length > 0">
					...
					<div class="relative z-0 mt-1 border border-card-border rounded-lg bg-card-background cursor-pointer">
						<button
							v-for="(role, i) in filterRoles(props.availableRoles)"
							:key="role.key"
							type="button"
