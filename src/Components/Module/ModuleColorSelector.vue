...
import { colors } from '@/Components/src/utils/color';
...
<template>
	<div>
		<Dropdown :align="'bottom'">
			<template #trigger>
				<button class="p-2 bg-input-background hover:bg-tertiary transition rounded-full border border-input-border">
					<div
						:style="{
