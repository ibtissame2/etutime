...
const buttonSizeClasses = {
	...
	large:
		'w-11 h-11 ring-accent-200/10 focus-visible:ring-ring focus-visible:ring-2 ring-4 sm:ring-[6px] hover:scale-110',
};
const iconClass = {
	small: 'w-2.5 h-2.5',
	base: 'w-3.5 h-3.5',
...
<template>
	...
	>
		<Transition name="fade" mode="out-in">
			...
			<svg v-else :class="iconClass[size || 'base']" viewBox="0 0 7 8" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
