...
const switchToTeam = (organization) => {
...
<template>
	<Dropdown v-if="page.props.jetstream.hasTeamFeatures" :align="'bottom'" width="60">
		...
		<template #content>
			<div class="w-60">
				<div class="block px-4 py-2 text-xs text-muted">Manage Organization</div>
				...
				<template v-if="page.props.auth.user.all_teams.length > 1">
					<div class="border-t border-card-background-separator"></div>

					<div class="block px-4 py-2 text-xs text-muted">Switch Organizations</div>
