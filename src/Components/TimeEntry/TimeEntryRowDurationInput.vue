<script setup>
import { calculateDifference, formatHumanReadableDuration } from '@/Components/src/utils/time';
...
const currentTime = computed({
	get() {
		...
		return formatHumanReadableDuration(calculateDifference(props.start, props.end));
	},
	set(newValue) {
		if (newValue) {
