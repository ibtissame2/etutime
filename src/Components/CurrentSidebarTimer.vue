	...
	<div class="pt-3 pb-2.5 px-2 flex justify-between items-center relative">
		...
		>
			...
			<div class="flex space-x-3 items-center w-full z-20 justify-center">
				<span class="text-xs text-center text-text-primary"> The Timer is running in a different organization. </span>
			</div>
		</div>
		<div>
		...
		<TimeTrackerStartStop :active="isActive" size="base" @changed="setActiveState"></TimeTrackerStartStop>
	</div>
</template>
