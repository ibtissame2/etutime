...
var St = /* @__PURE__ */ ((n) => (
	(n.VERBOSE = 'VERBOSE'), (n.INFO = 'INFO'), (n.WARN = 'WARN'), (n.ERROR = 'ERROR'), n
))(St || {});
const w = {
		BACKSPACE: 8,
		TAB: 9,
...
function It(n) {
	return (
		(n > 47 && n < 58) || // number keys
		n === 32 ||
		n === 13 || // Space bar & return key(s)
...
function Ve(n, e, t = void 0) {
	...
	return function () {
		...
		return (
			...
			(i = arguments),
			u <= 0 || u > e
				? (r && (clearTimeout(r), (r = null)), (l = c), (s = n.apply(o, i)), r || (o = i = null))
				: !r && t.trailing !== !1 && (r = setTimeout(a, u)),
			s
		);
	};
}
...
function Ao(n, e) {
	const t = Array.isArray(n) || R(n),
		o = Array.isArray(e) || R(e);
...
class d {
	...
	static get allInputsSelector() {
		return (
			...
			['text', 'password', 'email', 'number', 'search', 'tel', 'url'].map((t) => `input[type="${t}"]`).join(', ')
		);
	}
	/**
	...
	static findAllInputs(e) {
		return Mt(e.querySelectorAll(d.allInputsSelector)).reduce(
			(t, o) =>
				d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)],
			[]
		);
	}
	/**
	...
	static isNodeEmpty(e, t) {
		...
		return this.isSingleTag(e) && !this.isLineBreakTag(e)
			? !1
			: (this.isElement(e) && this.isNativeInput(e) ? (o = e.value) : (o = e.textContent.replace('​', '')),
	...
	static getDeepestBlockElements(e) {
		return d.containsOnlyInlineElements(e)
			? [e]
			: Array.from(e.children).reduce((t, o) => [...t, ...d.getDeepestBlockElements(o)], []);
	}
	/**
...
class b {
	...
	static isSelectionAtEditor(e) {
		...
		let o = null;
		return (
			t && t instanceof Element && (o = t.closest(`.${b.CSS.editorZone}`)), o ? o.nodeType === Node.ELEMENT_NODE : !1
		);
	}
	/**
	...
	removeFakeBackground() {
		this.isFakeBackgroundEnabled &&
			((this.isFakeBackgroundEnabled = !1), document.execCommand(this.commandRemoveFormat));
	}
	/**
		...
		return !i || !i.anchorNode || !i.focusNode
			...
			: ([
					...
					for (
						...
						a > 0 &&
						l.parentNode &&
						!(l.tagName === e && ((s = l), t && l.classList && !l.classList.contains(t) && (s = null), s));
...
function Fo(n, e) {
	...
	return n.type === 'attributes' && n.attributeName === 'data-empty'
		...
		: !!(
				e.contains(o) ||
				(t === 'childList' && (Array.from(i).some((a) => a === e) || Array.from(s).some((a) => a === e)))
		  );
}
const Je = 'redactor dom changed',
	Pt = 'block changed',
	Dt = 'fake cursor is about to be toggled',
	Rt = 'fake cursor have been set',
...
const Ut = class ke {
	...
	setCursor(e) {
		e < this.items.length &&
			e >= -1 &&
			(this.dropCursor(), (this.cursor = e), this.items[this.cursor].classList.add(this.focusedCssClass));
	}
	/**
	...
	leafNodesAndReturnIndex(e) {
		...
		let t = this.cursor;
		return (
			t === -1 ? (t = e === ke.directions.RIGHT ? -1 : 0) : this.items[t].classList.remove(this.focusedCssClass),
			e === ke.directions.RIGHT
				? (t = (t + 1) % this.items.length)
				: (t = (this.items.length + t - 1) % this.items.length),
			d.canSetCaret(this.items[t]) && Oe(() => b.setCursor(this.items[t]), 50)(),
...
class re {
	...
	constructor(e) {
		(this.iterator = null),
			...
			(this.iterator = new ge(e.items, e.focusedItemClass)),
			(this.activateCallback = e.activateCallback),
			(this.allowedKeys = e.allowedKeys || re.usedKeys);
	}
	/**
	...
	handleEnterPress(e) {
		this.activated &&
			(this.iterator.currentItem && (e.stopPropagation(), e.preventDefault(), this.iterator.currentItem.click()),
			A(this.activateCallback) && this.activateCallback(this.iterator.currentItem));
	}
	/**
...
const zo =
	...
	Vo =
		'<svg xmlns="http://www.w3.org/2000/svg" class="editor-white" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>',
	qo =
		'<svg xmlns="http://www.w3.org/2000/svg" class="editor-white" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>',
	jt =
		...
		return (function (t) {
			...
			return (
				...
				(i.t = function (s, r) {
					...
					if (
						(i.r(l), Object.defineProperty(l, 'default', { enumerable: !0, value: s }), 2 & r && typeof s != 'string')
					)
						for (var a in s)
							i.d(
								l,
	...
	constructor(e) {
		(this.nodes = {
			...
			e.description !== void 0 &&
				((this.nodes.description = d.make('div', be.description, { textContent: e.description })),
...
class ot {
	...
	onChildrenOpen() {
		...
		this.params !== void 0 &&
			...
			typeof ((e = this.params.children) == null ? void 0 : e.onOpen) == 'function' &&
	...
	onChildrenClose() {
		...
		this.params !== void 0 &&
			'children' in this.params &&
			typeof ((e = this.params.children) == null ? void 0 : e.onClose) == 'function' &&
...
class se extends ot {
	...
	constructor(e, t) {
		super(e),
			...
			(this.onErrorAnimationEnd = () => {
				var o, i;
				(o = this.nodes.icon) == null || o.classList.remove(L.wobbleAnimation),
					(i = this.nodes.icon) == null || i.removeEventListener('animationend', this.onErrorAnimationEnd);
			}),
	...
	make(e, t) {
		...
		return (
			...
			(this.nodes.icon = d.make('div', [L.icon, L.iconTool], {
				innerHTML: e.icon || Ko,
			})),
			...
			e.secondaryLabel &&
				i.appendChild(
					d.make('div', L.secondaryTitle, {
						textContent: e.secondaryLabel,
					})
				),
			this.hasChildren &&
				i.appendChild(
					d.make('div', [L.icon, L.iconChevronRight], {
						innerHTML: $o,
					})
				),
			...
			e.hint !== void 0 &&
				((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !== !1 &&
				this.addHint(i, {
					...e.hint,
	...
	disableSpecialHoverAndFocusBehavior() {
		...
		this.removeSpecialFocusBehavior(),
			this.removeSpecialHoverBehavior(),
			(e = this.nodes.root) == null || e.removeEventListener('mouseleave', this.removeSpecialHoverBehavior);
	}
	/**
	...
	animateError() {
		...
		((e = this.nodes.icon) != null && e.classList.contains(L.wobbleAnimation)) ||
			...
			(o = this.nodes.icon) == null || o.addEventListener('animationend', this.onErrorAnimationEnd));
	}
}
const Ue = te('ce-popover-item-separator'),
	je = {
		container: Ue(),
		line: Ue('line'),
...
var O = /* @__PURE__ */ ((n) => ((n.Default = 'default'), (n.Separator = 'separator'), (n.Html = 'html'), n))(O || {}),
	Z = /* @__PURE__ */ ((n) => ((n.Closed = 'closed'), (n.ClosedOnActivate = 'closed-on-activate'), n))(Z || {});
const H = te('ce-popover'),
	N = {
		popover: H(),
...
const yt = te('ce-popover-item-html'),
	Et = {
		root: yt(),
...
class Wt extends Be {
	...
	constructor(e, t = {}) {
		super(),
			...
			(this.nodes = {}),
			(this.nodes.popoverContainer = d.make('div', [N.popoverContainer])),
			(this.nodes.nothingFoundMessage = d.make('div', [N.nothingFoundMessage], {
				textContent: this.messages.nothingFound,
			})),
			this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage),
			(this.nodes.items = d.make('div', [N.items])),
			...
			(this.nodes.popover = d.make('div', [N.popover, this.params.class])),
	 ...
	 */
	hide() {
		this.nodes.popover.classList.remove(N.popoverOpened),
			this.nodes.popover.classList.remove(N.popoverOpenTop),
	...
	getTargetItem(e) {
		return this.items
			.filter((t) => t instanceof se || t instanceof ye)
			.find((t) => {
...
const Kt = class Xt extends Wt {
		...
		super(e, t),
			...
			(this.onSearch = (o) => {
				...
				this.items.forEach((a) => {
					let c = !1;
					a instanceof se ? (c = !o.items.includes(a)) : (a instanceof Yt || a instanceof ye) && (c = s || !i),
						a.toggleHidden(c);
				}),
			...
			this.nestingLevel > 0 && this.nodes.popover.classList.add(N.popoverNested),
			e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement),
			this.nodes.popoverContainer !== null &&
				this.listeners.on(this.nodes.popoverContainer, 'mouseover', (o) => this.handleHover(o)),
	...
	show() {
		var e;
		this.nodes.popover.style.setProperty(ce.PopoverHeight, this.size.height + 'px'),
			this.shouldOpenBottom || this.nodes.popover.classList.add(N.popoverOpenTop),
			this.shouldOpenRight || this.nodes.popover.classList.add(N.popoverOpenLeft),
			super.show(),
	...
	showNestedPopoverForItem(e) {
		...
		return (
			...
			t.style.setProperty(ce.NestingLevel, this.nestedPopover.nestingLevel.toString()),
	...
	get size() {
		...
		(t.style.visibility = 'hidden'),
			...
			(t.style.top = '-1000px'),
			t.classList.add(N.popoverOpened),
			(i = t.querySelector('.' + N.popoverNested)) == null || i.remove(),
	...
	get flippableElements() {
		return this.items
			.map((t) => {
				...
				if (t instanceof ye) return t.getControls();
			})
			.flat()
			.filter((t) => t != null);
	}
...
class di extends it {
	 ...
	 */
	show() {
		this.nestingLevel === 0 && this.nodes.popover.style.setProperty(ce.InlinePopoverWidth, this.size.width + 'px'),
			super.show();
	}
	/**
	...
	setTriggerItemPosition(e, t) {
		const o = t.getElement(),
			i = o ? o.offsetLeft : 0,
			s = this.offsetLeft + i;
		e.style.setProperty(ce.TriggerItemLeft, s + 'px');
	}
	/**
	 * Handles displaying nested items for the item.
	...
	handleItemClick(e) {
		...
		e !== this.nestedPopoverTriggerItem &&
			((t = this.nestedPopoverTriggerItem) == null || t.handleClick(), super.destroyNestedPopoverIfExists()),
...
const Vt = class ve {
	...
	lockHard() {
		(this.scrollPosition = window.pageYOffset),
			document.documentElement.style.setProperty('--window-scroll-offset', `${this.scrollPosition}px`),
	 ...
	 */
	unlockHard() {
		document.body.classList.remove(ve.CSS.scrollLockedHard),
...
class ui {
	...
	constructor({ text: e, onBackButtonClick: t }) {
		(this.listeners = new Te()),
			...
			(this.nodes.backButton.innerHTML = jo),
...
class qt extends Wt {
	...
	constructor(e) {
		super(e, {
			...
			(this.scrollLocker = new hi()),
			(this.history = new pi()),
			(this.isHidden = !0),
			(this.nodes.overlay = d.make('div', [N.overlay, N.overlayHidden])),
	...
	hide() {
		this.isHidden ||
			(super.hide(),
			this.nodes.overlay.classList.add(N.overlayHidden),
	...
	updateItemsAndHeader(e, t) {
		if (
			(this.header !== null && this.header !== void 0 && (this.header.destroy(), (this.header = null)), t !== void 0)
		) {
			this.header = new ui({
				text: t,
				onBackButtonClick: () => {
...
class D extends Be {
	 ...
	 */
	constructor({ id: e = Io(), data: t, tool: o, readOnly: i, tunesData: s }, r) {
		super(),
			(this.cachedInputs = []),
				...
				a || c
					...
					: (u = !(
							...
							l.every((p) => {
								...
								return [...Array.from(g), ...Array.from(f), k].some(
									(S) => (
										d.isElement(S) || (S = S.parentElement), S && S.closest('[data-mutation-free="true"]') !== null
									)
								);
							})
					  )),
	...
	set selected(e) {
		...
		(t || o) &&
			((i = this.editorEventBus) == null || i.emit(Dt, { state: e }),
			t ? b.addFakeCursor() : b.removeFakeCursor(this.holder),
			(s = this.editorEventBus) == null || s.emit(Rt, { state: e }));
	}
	/**
	...
	updateCurrentInput() {
		this.currentInput =
			d.isNativeInput(document.activeElement) || !b.anchorNode ? document.activeElement : b.anchorNode;
	}
	/**
	 * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
	 * Can be useful for block changes invisible for editor core.
	...
	destroy() {
		this.unwatchBlockMutations(),
			...
			super.destroy(),
			A(this.toolInstance.destroy) && this.toolInstance.destroy();
	}
	/**
	 * Tool could specify several entries to be displayed at the Toolbox (for example, "Heading 1", "Heading 2", "Heading 3")
	 * This method returns the entry that is related to the Block (depended on the Block data)
...
class fi extends y {
	 ...
	 */
	stretchBlock(e, t = !0) {
		Ze(!0, 'blocks.stretchBlock()', 'BlockAPI');
...
class mi extends y {
	constructor() {
		super(...arguments),
			(this.setToFirstBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
				this.Editor.BlockManager.firstBlock
					? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.firstBlock, e, t), !0)
					: !1),
			(this.setToLastBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
				this.Editor.BlockManager.lastBlock
					? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.lastBlock, e, t), !0)
					: !1),
			(this.setToPreviousBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
				this.Editor.BlockManager.previousBlock
					? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.previousBlock, e, t), !0)
					: !1),
			(this.setToNextBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
				this.Editor.BlockManager.nextBlock
					? (this.Editor.Caret.setToBlock(this.Editor.BlockManager.nextBlock, e, t), !0)
					: !1),
...
`);
						...
						(s.i = function (r, l) {
							...
							for (c = 0; c < r.length; c++) {
								var h = r[c];
								(typeof h[0] == 'number' && a[h[0]]) ||
									(l && !h[2] ? (h[2] = l) : l && (h[2] = '(' + h[2] + ') and (' + l + ')'), s.push(h));
							}
						}),
						s
					);
			...
			function (t, o, i) {
				...
				function C(v, m) {
					...
					var E = p[p.length - 1];
					if (v.insertAt === 'top')
						E ? (E.nextSibling ? x.insertBefore(m, E.nextSibling) : x.appendChild(m)) : x.insertBefore(m, x.firstChild),
							p.push(m);
						...
						typeof btoa == 'function'
							? ((x = (function (B) {
							  ...
							  (E = function (B, Y, fe) {
									var ie = fe.css,
										He = fe.sourceMap,
										mo = Y.convertToAbsoluteUrls === void 0 && He;
									(Y.convertToAbsoluteUrls || mo) && (ie = g(ie)),
										He &&
											(ie +=
												`
/*# sourceMappingURL=data:application/json;base64,` +
												btoa(unescape(encodeURIComponent(JSON.stringify(He)))) +
												' */');
									var bo = new Blob([ie], { type: 'text/css' }),
										gt = B.href;
							...
							: ((x = _(m)),
							  (E = function (B, Y) {
									var fe = Y.css,
										ie = Y.media;
									if ((ie && B.setAttribute('media', ie), B.styleSheet)) B.styleSheet.cssText = fe;
									else {
				...
				t.exports = function (i) {
					...
					return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (a, c) {
						...
						return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(h)
							? a
							: ((u = h.indexOf('//') === 0 ? h : h.indexOf('/') === 0 ? r + h : l + h.replace(/^\.\//, '')),
				...
				t.exports =
					...
					(p = 'cdx-notify__btns-wrapper'),
					{
						alert: (g = function (f) {
							...
							return (
								k.classList.add(r),
								_ && k.classList.add(r + '--' + _),
								(k.innerHTML = S),
								C.classList.add(l),
								C.addEventListener('click', k.remove.bind(k)),
								k.appendChild(C),
								k
							);
						}),
						confirm: function (f) {
							var k = g(f),
								...
								ee = k.querySelector('.' + l),
								j = f.cancelHandler,
								$ = f.okHandler;
							return (
								C.classList.add(p),
								(S.innerHTML = f.okText || 'Confirm'),
								(_.innerHTML = f.cancelText || 'Cancel'),
								S.classList.add(h),
								_.classList.add(h),
								S.classList.add(a),
								_.classList.add(c),
								j && typeof j == 'function' && (_.addEventListener('click', j), ee.addEventListener('click', j)),
								$ && typeof $ == 'function' && S.addEventListener('click', $),
								S.addEventListener('click', k.remove.bind(k)),
								_.addEventListener('click', k.remove.bind(k)),
								C.appendChild(S),
								C.appendChild(_),
								k.appendChild(C),
								k
						...
						prompt: function (f) {
							...
							return (
								...
								S.classList.add(a),
								_.classList.add(u),
								f.placeholder && _.setAttribute('placeholder', f.placeholder),
								f.default && (_.value = f.default),
								f.inputType && (_.type = f.inputType),
								j && typeof j == 'function' && ee.addEventListener('click', j),
								$ &&
									typeof $ == 'function' &&
			...
			(t.prototype._sanitize = function (h, p) {
				...
				if (f)
					do {
						...
						var S = !!p.parentNode,
							_ = i(p) && i(f) && S,
							ee = f.nodeName.toLowerCase(),
							j = a(this.config, ee, f),
							$ = k && C;
						if ($ || c(f, j) || (!this.config.keepNestedBlockElements && _)) {
							if (!(f.nodeName === 'SCRIPT' || f.nodeName === 'STYLE'))
								for (; f.childNodes.length > 0; ) p.insertBefore(f.childNodes[0], f);
							p.removeChild(f), this._sanitize(h, p);
							break;
						}
...
class Ui extends y {
	...
	resolveTuneAliases(e) {
		if (e.type === O.Separator || e.type === O.Html) return e;
...
var Wi = Object.defineProperty,
	...
	Ce = /* @__PURE__ */ ((n) => (
		(n.Opened = 'toolbox-opened'), (n.Closed = 'toolbox-closed'), (n.BlockAdded = 'toolbox-block-added'), n
	))(Ce || {});
...
eo([he], lt.prototype, 'toolsToBeDisplayed', 1);
eo([he], lt.prototype, 'toolboxItemsToBeDisplayed', 1);
let Xi = lt;
...
class qi extends y {
	...
	close() {
		...
		this.Editor.ReadOnly.isEnabled ||
			((e = this.nodes.wrapper) == null || e.classList.remove(this.CSS.toolbarOpened),
	...
	async make() {
		...
		const e = d.make('div');
		e.appendChild(document.createTextNode(z.ui(K.ui.toolbar.toolbox, 'Add'))),
			e.appendChild(
	...
	makeToolbox() {
		return (
			...
			this.toolboxInstance.on(Ce.BlockAdded, ({ block: e }) => {
				...
				i.inputs.length === 0 &&
					(i === t.lastBlock ? (t.insertAtEnd(), o.setToBlock(t.lastBlock)) : o.setToBlock(t.nextBlock));
			}),
...
var Fe = /* @__PURE__ */ ((n) => (
		(n[(n.Block = 0)] = 'Block'), (n[(n.Inline = 1)] = 'Inline'), (n[(n.Tune = 2)] = 'Tune'), n
	))(Fe || {}),
	Se = /* @__PURE__ */ ((n) => (
		(n.Shortcut = 'shortcut'),
		(n.Toolbox = 'toolbox'),
	...
	io = /* @__PURE__ */ ((n) => ((n.Shortcut = 'shortcut'), (n.SanitizeConfig = 'sanitize'), n))(io || {}),
	ae = /* @__PURE__ */ ((n) => (
	...
	at = /* @__PURE__ */ ((n) => ((n.IsInline = 'isInline'), (n.Title = 'title'), n))(at || {}),
	Qe = /* @__PURE__ */ ((n) => ((n.IsTune = 'isTune'), n))(Qe || {});
class ct {
	/**
	 * @class
	...
	get settings() {
		...
		return (
			this.isDefault && !('placeholder' in e) && this.defaultPlaceholder && (e.placeholder = this.defaultPlaceholder), e
		);
	}
	/**
...
class Zi extends y {
	...
	constructor({ config: e, eventsDispatcher: t }) {
		super({
			...
			(this.opened = !1),
			(this.popover = null),
			(this.toolbarVerticalMargin = ue() ? 20 : 6),
	...
	move(e) {
		const t = b.rect,
			...
			i = {
				...
				y:
					t.y +
					t.height - // + window.scrollY
					o.top +
					this.toolbarVerticalMargin,
			};
		i.x + e + o.x > this.Editor.UI.contentRect.right && (i.x = this.Editor.UI.contentRect.right - e - o.x),
	...
	async getInlineTools() {
		...
		for (let s = 0; s < o.length; s++) {
			...
			const u = c !== void 0 ? et(c) : void 0,
				h = z.t(K.toolNames, r.title || Ae(r.name));
			[a].flat().forEach((p) => {
				var f, k;
				const g = {
					name: r.name,
...
function so() {
	...
	return e === null
		...
		: (e.nodeType !== Node.TEXT_NODE &&
				...
				(e.childNodes[t] ? ((e = e.childNodes[t]), (t = 0)) : ((e = e.childNodes[t - 1]), (t = e.textContent.length))),
		  [e, t]);
}
function no(n, e, t, o) {
...
class Gi extends y {
	...
	keydown(e) {
		...
		e.key === '/' && !e.ctrlKey && !e.metaKey && this.slashPressed(e),
			e.code === 'Slash' && (e.ctrlKey || e.metaKey) && (e.preventDefault(), this.commandSlashPressed());
	}
	/**
	...
	slashPressed(e) {
		this.Editor.BlockManager.currentBlock.isEmpty &&
			(e.preventDefault(), this.Editor.Caret.insertContentAtCaretPosition('/'), this.activateToolbox());
	}
	/**
	...
	enter(e) {
		...
		i.currentInput !== void 0 && Ie(i.currentInput) && !i.hasMedia
			...
			: i.currentInput && Me(i.currentInput)
	...
	backspace(e) {
		...
		if (i === void 0 || !b.isCollapsed || !i.currentInput || !Ie(i.currentInput)) return;
	...
	delete(e) {
		...
		if (!b.isCollapsed || !Me(i.currentInput)) return;
	...
	arrowRightAndDown(e) {
		...
		const { currentBlock: o } = this.Editor.BlockManager,
			s =
				((o == null ? void 0 : o.currentInput) !== void 0 ? Me(o.currentInput) : void 0) ||
		...
		if (
			e.keyCode === w.DOWN || (e.keyCode === w.RIGHT && !this.isRtl)
	...
	arrowLeftAndUp(e) {
		if (this.Editor.UI.someToolbarOpened) {
			if (re.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === w.TAB)) return;
			this.Editor.UI.closeAllToolbars();
		}
		this.Editor.Toolbar.close();
		const { currentBlock: t } = this.Editor.BlockManager,
			i =
				((t == null ? void 0 : t.currentInput) !== void 0 ? Ie(t.currentInput) : void 0) ||
				this.Editor.BlockSelection.anyBlockSelected;
		...
		if (
			e.keyCode === w.UP || (e.keyCode === w.LEFT && !this.isRtl)
				? this.Editor.Caret.navigatePrevious()
				: this.Editor.Caret.navigateNext()
		) {
			e.preventDefault();
...
class es extends y {
	...
	insert({
		...
		return (
			r &&
				this.blockDidMutated(Bt, this.getBlockByIndex(a), {
					index: a,
				}),
			this._blocks.insert(a, c, r),
			this.blockDidMutated(Tt, c, {
				index: a,
			}),
	...
	move(e, t = this.currentBlockIndex) {
		...
		this._blocks.move(e, t),
			...
			this.blockDidMutated(Ji, this.currentBlock, {
				fromIndex: t,
				toIndex: e,
			});
	}
...
class ts extends y {
	...
	get anyBlockSelected() {
		const { BlockManager: e } = this.Editor;
		return (
			this.anyBlockSelectedCache === null && (this.anyBlockSelectedCache = e.blocks.some((t) => t.selected === !0)),
...
class os extends y {
	...
	toggleBlockSelectedState(e = !0) {
		...
		this.lastSelectedBlock || (this.lastSelectedBlock = this.firstSelectedBlock = t.currentBlock),
			this.firstSelectedBlock === this.lastSelectedBlock &&
				((this.firstSelectedBlock.selected = !0), o.clearCache(), b.get().removeAllRanges());
	...
	enableCrossBlockSelection(e) {
		...
		b.isCollapsed || this.Editor.BlockSelection.clearSelection(e),
			t.nodes.redactor.contains(e.target) ? this.watchSelection(e) : this.Editor.BlockSelection.clearSelection(e);
	}
	/**
	...
	toggleBlocksSelectedState(e, t) {
		...
		for (let a = Math.min(s, r); a <= Math.max(s, r); a++) {
			...
			c !== this.firstSelectedBlock &&
				c !== (l ? e : t) &&
				((o.blocks[a].selected = !o.blocks[a].selected), i.clearCache());
		}
	}
}
class is extends y {
...
const ro = class lo extends y {
	constructor() {
		super(...arguments),
			...
			(this.handlePasteEvent = async (e) => {
				...
				!i ||
					(this.isNativeBehaviour(e.target) && !e.clipboardData.types.includes('Files')) ||
					(i && this.exceptionList.includes(i.name)) ||
					(e.preventDefault(), this.processDataTransfer(e.clipboardData), o.close());
			});
	}
	/**
	...
	async processDataTransfer(e, t = !1) {
		...
		const c = Object.keys(this.toolsTags).reduce(
				(p, g) => ((p[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}), p),
				{}
			),
	...
	async processText(e, t = !1) {
		...
		s.map(async (a, c) => this.insertBlock(a, c === 0 && l)),
	...
	getFilesConfig(e) {
		...
		(!o && !i) ||
			(o &&
				!Array.isArray(o) &&
				(I(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), (o = [])),
			i &&
				!Array.isArray(i) &&
				(I(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), (i = [])),
			i &&
				(i = i.filter((s) =>
					To(s) ? !0 : (I(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, 'warn'), !1)
				)),
	...
	getPatternsConfig(e) {
		e.pasteConfig === !1 ||
			...
			Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
				o instanceof RegExp ||
					I(`Pattern ${o} for «${e.name}» Tool is skipped because it should be a Regexp instance.`, 'warn'),
			...
			this.getNodes(o)
				.map((s) => {
					...
					const { tags: c } = l.pasteConfig || { tags: [] },
						u = c.reduce(
							(g, f) => (
								this.collectTagNames(f).forEach((C) => {
	...
	insertEditorJSData(e) {
		...
		nt(e, (r) => i.blockTools.get(r).sanitizeConfig).forEach(({ tool: r, data: l }, a) => {
			let c = !1;
...
class we extends y {
	...
	genHTML() {
		const { UI: e } = this.Editor,
			...
			o = d.make('div', we.CSS.overlay, {}),
			i = d.make('div', we.CSS.overlayContainer, {}),
			s = d.make('div', we.CSS.rect, {});
		return (
			i.appendChild(s),
			o.appendChild(i),
			t.appendChild(o),
	...
	inverseSelection() {
		...
		if (this.rectCrossesBlocks && !t)
			for (const o of this.stackOfSelected) this.Editor.BlockSelection.selectBlockByIndex(o);
		if (!this.rectCrossesBlocks && t)
			for (const o of this.stackOfSelected) this.Editor.BlockSelection.unSelectBlockByIndex(o);
	}
	/**
	...
	trySelectNextBlock(e) {
		...
		for (
			...
			this.rectCrossesBlocks && this.Editor.BlockSelection.unSelectBlockByIndex(this.stackOfSelected[g]),
		...
		return new Promise((t) => {
			...
			if (e.length === 0) i.insert();
				...
				const s = e.map(({ type: r, data: l, tunes: a, id: c }) => {
					o.available.has(r) === !1 &&
						(X(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, 'warn'),
	...
	async save() {
		...
		try {
			...
			const s = await Promise.all(i),
				r = await nt(s, (l) => t.blockTools.get(l).sanitizeConfig);
...
class ut {
	...
	render() {
		return (
			...
			(this.nodes.button.innerHTML = Xo),
			this.nodes.button
		);
	}
	/**
...
class pt {
	...
	render() {
		return (
			...
			(this.nodes.button.type = 'button'),
			this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier),
			(this.nodes.button.innerHTML = xt),
			this.nodes.button
		);
	}
	/**
	...
	checkState() {
		...
		if (e) {
			(this.nodes.button.innerHTML = Go),
...
class ft extends ct {
	 ...
	 */
	get toolbox() {
		const e = this.constructable[ae.Toolbox],
			t = this.config[Se.Toolbox];
		if (!V(e) && t !== !1)
			return t
				? Array.isArray(e)
					? Array.isArray(t)
	...
	get baseSanitizeConfig() {
		const e = {};
		return (
			Array.from(this.inlineTools.values()).forEach((t) => Object.assign(e, t.sanitizeConfig)),
			Array.from(this.tunes.values()).forEach((t) => Object.assign(e, t.sanitizeConfig)),
			e
		);
	}
}
ho([he], ft.prototype, 'sanitizeConfig', 1);
ho([he], ft.prototype, 'baseSanitizeConfig', 1);
class bs {
	/**
	 * @class
...
class go extends y {
	...
	async prepare() {
		if (
			(this.validateTools(),
			(this.config.tools = qe({}, this.internalTools, this.config.tools)),
			!Object.prototype.hasOwnProperty.call(this.config, 'tools') || Object.keys(this.config.tools).length === 0)
		)
	...
	toolPrepareMethodSuccess(e) {
		...
		if (t.isInline()) {
			...
			if (i.length) {
				I(`Incorrect Inline Tool: ${t.name}. Some of required methods is not implemented %o`, 'warn', i),
...
class ys extends y {
	...
	get contentRect() {
		...
		return e
			? ((this.contentRectCache = e.getBoundingClientRect()), this.contentRectCache)
			: {
					width: 650,
					left: 0,
					right: 0,
	...
	get someFlipperButtonFocused() {
		return this.Editor.Toolbar.toolbox.hasFocus()
			...
			: Object.entries(this.Editor)
					.filter(([e, t]) => t.flipper instanceof re)
	...
	documentClicked(e) {
		...
		this.nodes.holder.contains(t) ||
			b.isAtEditor ||
			(this.Editor.BlockManager.unsetCurrentBlock(), this.Editor.Toolbar.close());
	...
	processBottomZoneClick(e) {
		...
		if (
			...
			(!l.lastBlock.tool.isDefault || !l.lastBlock.isEmpty) && l.insertAtEnd(),
				a.setToTheLastBlock(),
				c.moveAndOpen(l.lastBlock);
		}
	}
	/**
	...
	selectionChanged() {
		...
		(o.closest(`.${D.CSS.content}`) === null &&
			(this.Editor.InlineToolbar.containsNode(o) || this.Editor.InlineToolbar.close(),
...
class Bs {
		...
		(this.isReady = new Promise((i, s) => {
			...
			Promise.resolve()
				.then(async () => {
					...
					r.checkEmptiness(),
						l.enable(),
						this.configuration.autofocus && s.setToBlock(i.blocks[0], s.positions.START),
						t();
				})
				.catch((i) => {
	...
	set configuration(e) {
		...
		R(e)
			...
			Ze(!!this.config.holderId, 'config.holderId', 'config.holder'),
			this.config.holderId &&
				!this.config.holder &&
				((this.config.holder = this.config.holderId), (this.config.holderId = null)),
			this.config.holder == null && (this.config.holder = 'editorjs'),
			this.config.logLevel || (this.config.logLevel = St.VERBOSE),
			xo(this.config.logLevel),
			Ze(!!this.config.initialBlock, 'config.initialBlock', 'config.defaultBlock'),
		...
		(this.config.placeholder = this.config.placeholder || !1),
			...
			(V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) &&
				(this.config.data = { blocks: [t] }),
			(this.config.readOnly = this.config.readOnly || !1),
			(o = this.config.i18n) != null && o.messages && z.setDictionary(this.config.i18n.messages),
			...
			(t, o) =>
				t.then(async () => {
					try {
						...
						if (i instanceof Nt) throw new Error(i.message);
