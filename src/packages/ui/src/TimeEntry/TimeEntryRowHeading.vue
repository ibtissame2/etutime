...
import { formatDate, formatHumanReadableDuration, formatWeekday } from '@/packages/ui/src/utils/time';
...
<template>
	<div class="bg-row-heading-background border-t border-b border-row-heading-border py-1 text-xs sm:text-sm">
		<MainContainer>
