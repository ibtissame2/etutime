...
const billableRateSelect = ref('non-billable');
const billableRate = defineModel('billableRate');
const isBillable = defineModel('isBillable');
...
const billableOptionInfoTexts = {
	'non-billable': 'New time entries for this project will not be marked billable by default.',
	'default-rate': 'New time entries for this project will be billable at the default rate by default.',
	'custom-rate': 'New time entries for this project will be billable at a custom rate by default.',
};
...
<template>
	<div class="sm:flex items-center space-y-2 sm:space-y-0 sm:space-x-4 pt-6">
		<div>
			...
			<ProjectBillableSelect v-model="billableRateSelect" class="mt-2"></ProjectBillableSelect>
		</div>
		<div v-if="billableRateSelect === 'custom-rate'" class="sm:max-w-[120px]">
