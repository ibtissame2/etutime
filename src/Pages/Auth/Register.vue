		...
		<form @submit.prevent="submit">
			...
			<div v-if="page.props.newsletter_consent" class="mt-4">
				<InputLabel for="newsletter_consent">
					<div class="flex items-center">
						<Checkbox id="newsletter_consent" v-model:checked="form.newsletter_consent" name="newsletter_consent" />

						<div class="ms-2">I agree to receive emails about product related updates</div>
					</div>
