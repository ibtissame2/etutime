...
<template>
	<AppLayout title="Reporting" data-testid="reporting_view" class="overflow-hidden">
		...
		<div v-if="!isAllowedToPerformPremiumAction()">
			<div class="py-12">
				...
				<div class="max-w-sm text-center mx-auto py-4 text-base">
					...
					<p class="py-1">
						If you want to use <strong>sharable reports</strong> , <strong>please upgrade to a paid plan</strong>.
					</p>
		...
		<ReportTable v-if="reports.length > 0 || isAllowedToPerformPremiumAction()" :reports="reports"></ReportTable>
