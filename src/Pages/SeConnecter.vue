        ...
        <form @submit.prevent="handleRegister">
          ...
          <div class="form-options">
            <label class="checkbox-container">
              ...
              <span class="checkmark"></span>
              J'accepte les <a href="#" @click.prevent="showTerms = true">conditions d'utilisation</a> et la <a href="#" @click.prevent="showPrivacy = true">politique de confidentialité</a>
            </label>
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="handleResetPassword">
          ...
          <div class="modal-actions">
            <button type="button" class="btn-cancel" @click="showResetPassword = false">
              Annuler
            </button>
...
export default {
  ...
  data() {
    return {
      ...
      errors: {},
      apiBaseUrl: 'http://localhost/etutime/front-end/src/API/connection',
    }
  },
  ...
  methods: {
    ...
    validateRegisterForm() {
      ...
      } else if (!/[a-z]/.test(this.registerForm.password) || 
