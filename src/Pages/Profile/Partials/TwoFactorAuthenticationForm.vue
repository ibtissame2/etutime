...
<template>
	<ActionSection>
		...
		<template #content>
			<h3 v-if="twoFactorEnabled && !confirming" class="text-lg font-medium text-text-secondary">
				You have enabled two factor authentication.
			</h3>

			<h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-text-secondary">
				Finish enabling two factor authentication.
			</h3>

			<h3 v-else class="text-lg font-medium text-text-primary">You have not enabled two factor authentication.</h3>
			...
			<div v-if="twoFactorEnabled">
				<div v-if="qrCode">
					...
					<div v-if="setupKey" class="mt-4 max-w-xl text-sm text-muted">
			...
			<div class="mt-5">
				...
				<div v-else>
					...
					<ConfirmsPassword @confirmed="disableTwoFactorAuthentication">
						<SecondaryButton v-if="confirming" :class="disabling ? 'opacity-25' : ''" :disabled="disabling">
							Cancel
						</SecondaryButton>
					</ConfirmsPassword>
