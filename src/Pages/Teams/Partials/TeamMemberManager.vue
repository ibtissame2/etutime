	...
	<div>
			...
			<FormSection @submitted="addTeamMember">
				...
				<template #form>
					...
					<div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
						...
						<div class="relative z-0 mt-1 border border-card-border rounded-lg cursor-pointer">
							<button
								...
								:class="{
									'border-t border-card-border focus:border-none rounded-t-none': i > 0,
		...
		<div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
			...
			<ActionSection class="mt-10 sm:mt-0">
				...
				<template #description>
					These people have been invited to your organization and have been sent an invitation email. They may join the
		...
		<div v-if="users.length > 0">
			...
			<ActionSection class="mt-10 sm:mt-0">
				...
				<template #description> All of the people that are part of this organization. </template>
		...
		<ConfirmationModal :show="!!teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
			...
			<template #content> Are you sure you would like to remove this person from the organization? </template>
