...
<template>
	<FormSection>
		...
		<template #description> Configure the default billable rate for the organization. </template>
			...
			<div class="col-span-6">
				<div class="col-span-6 sm:col-span-4">
					<div class="flex items-center space-x-2">
						...
						></Checkbox>
						<InputLabel for="organizationShowBillableRatesToEmployees" value="Show Billable Rates to Employees" />
					</div>
				</div>
			</div>
		</template>
